...
const imageFormats = [
  { value: "jpg", label: "JPG/JPEG", description: "Best for photos" },
  ...
  const handleProcess = async () => {
    ...
    const response = await fetch("/api/task", {
      ...
      body: JSON.stringify({
        ...
        params: { format: outputFormat, quality },
      }),
    });
      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Convert images between formats</p>
          </div>
        </div>
