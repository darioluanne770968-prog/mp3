      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Extract tables from PDF to Excel spreadsheets</p>
          </div>
        </div>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="p-4 bg-muted rounded-lg">
                    ...
                    <ul className="text-sm text-muted-foreground space-y-1">
                      <li>• Tables will be extracted and converted</li>
                      <li>• Each page becomes a separate sheet</li>
                      <li>• Output format: XLSX (Microsoft Excel)</li>
                    </ul>
                  </div>
